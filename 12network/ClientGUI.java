...
{  
	...
	public ClientGUI()
	{
		try 
		{
		    ...
		    f=new JFrame("Chat");
			f.setTitle("Network Chat Client");
			...
			f.setSize(600,300);
			f.setVisible(true);
			//Sok=new Socket("DESKTOP-ND4S1EA",4000);
			Sok=new Socket("localhost",4000); 
